...
namespace DepotDownloader
{
    ...
    static class ContentDownloader
    {
            ...
            GlobalDownloadCounter downloadCounter, DepotFilesData depotFilesData, HashSet<String> allFileNamesAllDepots)
        {
            ...
            {
                var previousFilteredFiles = new HashSet<string>();
                depotFilesData.previousManifest.Files.AsParallel().Where(f => TestIsFileIncluded(f.FileName)).Select(f => f.FileName).ForAll(f => previousFilteredFiles.Add(f));
